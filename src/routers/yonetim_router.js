...
const multerConfig = require('../config/multer_config.js');
...
router.post('/profil-guncelle',authMiddleware.oturumAcilmis,multerConfig.single('avatar'),yonetimController.profilSayfasiniGuncelle);
